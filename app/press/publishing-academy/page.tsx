...
const ARINPublishingAcademy = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            {/* Clean Header */}
            <div className="border-b-4" style={{ borderColor: '#00c4b3' }}>
                <div className="container mx-auto px-4 py-8">
                    <div className="max-w-6xl mx-auto">
                        <div className="flex items-center gap-4 mb-4">
                            <div className="w-16 h-16 rounded-lg flex items-center justify-center shadow-lg" style={{ backgroundColor: '#021d49' }}>
                                <BookOpen className="w-8 h-8 text-white" />
                            </div>
                            <div>
                                <h1 className="text-3xl md:text-4xl font-bold" style={{ color: '#021d49', borderColor: '#00c4b3' }}>
                                    ARIN Publishing Academy
                                </h1>
                                <p className="text-lg text-gray-600 mt-1">
                                    Strengthening Africa's Research, Writing, and Policy Translation Capacities
                                </p>
                            </div>
                        </div>
                    </div>
