...
const VideoGalleryPage = () => {
    ...
    const videos = [
        {
            id: 1,
            title: 'Africa Climate Summit 2025 Highlights',
            category: 'Events',
            date: 'November 2025',
            duration: '15:30',
            thumbnail: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Key moments and insights from the Africa Climate Summit 2025, featuring discussions on adaptation strategies and policy frameworks'
        },
        {
            id: 2,
            title: 'Community-Led Adaptation: Stories from Kenya',
            category: 'Research',
            date: 'October 2025',
            duration: '12:45',
            thumbnail: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Documentary showcasing locally-led adaptation initiatives and their impact on rural communities in Kenya'
        },
        {
            id: 3,
            title: 'Policy Dialogue: Sustainable Development Goals',
            category: 'Webinars',
            date: 'September 2025',
            duration: '45:00',
            thumbnail: 'https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Expert panel discussion on aligning climate adaptation with SDGs across African nations'
        },
        {
            id: 4,
            title: 'ARIN Research Methods Workshop',
            category: 'Workshops',
            date: 'August 2025',
            duration: '30:15',
            thumbnail: 'https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Training session on innovative research methodologies for climate adaptation studies'
        },
        {
            id: 5,
            ...
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Young leaders share their perspectives on climate action and sustainable futures'
        },
        {
            id: 6,
            title: 'Agricultural Innovation Showcase',
            category: 'Research',
            date: 'June 2025',
            duration: '18:20',
            thumbnail: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Exploring climate-resilient agricultural practices and technologies across Africa'
        },
        {
            id: 7,
            title: 'Pre-COP Webinar Series: Episode 1',
            category: 'Webinars',
            date: 'May 2025',
            duration: '60:00',
            thumbnail: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'First episode of the Pre-COP webinar series discussing adaptation metrics and frameworks'
        },
        {
            id: 8,
            title: 'Impact Stories: Coastal Communities',
            category: 'Documentaries',
            date: 'April 2025',
            duration: '25:45',
            thumbnail: 'https://images.unsplash.com/photo-1464618663641-bbdd760ae84a?w=800&q=80',
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'How coastal communities are adapting to climate change and rising sea levels'
        },
        {
            id: 9,
            ...
            videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ',
            description: 'Full recording of the ARIN Annual Conference featuring keynote speakers and panel discussions'
        }
    ];
                ...
                <section className="max-w-[1400px] mx-auto px-6 py-12">
                    <div className="text-center mb-8">
                        <div className="flex items-center justify-center gap-3 mb-4">
                            <Video className="w-12 h-12 text-[#46a1bb]" />
                        </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                        {currentVideos.map((video) => (
                            <div
                                key={video.id}
                                className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 hover:border-[#46a1bb] cursor-pointer group"
                            ...
                            >
                                ...
                                <div className="relative aspect-video overflow-hidden">
                                    ...
                                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center group-hover:bg-black/50 transition-colors">
                                        <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                                            <Play className="w-8 h-8 text-[#46a1bb] ml-1" fill="currentColor" />
                                        </div>
                                    </div>
                                    {/* Duration Badge */}
                                    ...
                                    <div className="absolute top-2 left-2">
                                        <span className="px-3 py-1 bg-[#46a1bb] text-white text-xs font-bold rounded-full">
                                            {video.category}
                                        </span>
                                    </div>
                                </div>
                                ...
                                {/* Content */}
                                <div className="p-5">
                                    <h3 className="text-lg font-bold text-gray-900 mb-2 line-clamp-2 group-hover:text-[#46a1bb] transition-colors">
                                        {video.title}
                                    </h3>
