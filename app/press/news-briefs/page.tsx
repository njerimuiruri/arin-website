                    ...
                    >
                        ...
                        <div className="p-6 flex flex-col grow">
                            ...
                            <button
                                ...
                                className="mt-auto w-full px-4 py-3 bg-linear-to-r from-[#021d49] to-[#021d49] hover:shadow-xl text-white font-semibold rounded-lg shadow-md flex items-center gap-2 justify-center transition-all duration-200"
                            >
                                <span>read more</span>
                ...
                <div className="bg-linear-to-br from-[#021d49] via-gray-900 to-[#021d49] rounded-2xl p-10 text-white shadow-2xl">
                    <div className="grid md:grid-cols-3 gap-8 mb-8">
                        <div className="text-center">
                            <Newspaper className="w-10 h-10 text-[#021d49] mx-auto mb-4" />
