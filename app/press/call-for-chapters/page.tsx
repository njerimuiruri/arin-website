...
const CallForBooksPage = () => {
    ...
    const filteredCalls = calls.filter(call => {
        ...
        const matchesCategory = selectedCategory === 'All' || call.category.includes(selectedCategory);
    ...
    const handleCallClick = (callId) => {
        ...
        alert(`Navigate to call for book chapters: ${callId}\n\nIn your Next.js app, use:\nrouter.push(\`/call-for-books/${callId}\`)`);
    };
                    ...
                    <div className="max-w-4xl mx-auto mb-8">
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            <div className="bg-white rounded-xl p-4 shadow-md border border-gray-200 text-center">
                                <div className="text-3xl font-bold text-[#46a1bb] mb-1">{calls.length}</div>
                                ...
                                <div className="md:flex">
                                    ...
                                    <div className="md:w-3/5 p-8">
                                        ...
                                        <div className="mb-4 bg-gray-50 rounded-lg p-4">
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="flex items-center gap-2 text-sm">
                                                    ...
                                                    <span className="text-gray-600">{call.postedDate}</span>
                                                </div>
                                                <div className="flex items-center gap-2 text-sm">
                                        ...
                                        <div className="flex flex-wrap gap-2 mb-4">
                                            {call.category.split(', ').map((tag, index) => (
                                                <span
                                                    key={index}
                                        ...
                                        <div className="flex items-center justify-end">
                                            <button
                                                onClick={(e) => { e.stopPropagation(); handleCallClick(call.id); }}
                                                className={`px-6 py-3 ${call.status === 'Open' ? 'bg-gradient-to-r from-[#021d49] to-[#46a1bb] hover:shadow-xl' : 'bg-gray-400'} text-white font-semibold rounded-lg shadow-md flex items-center gap-2 justify-center transition-all duration-200 whitespace-nowrap`}
                                            >
                ...
                <section className="max-w-[1400px] mx-auto px-6 pb-16 mt-12">
                    <div className="bg-gradient-to-br from-[#021d49] via-gray-900 to-[#021d49] rounded-2xl p-10 text-white shadow-2xl">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-8">
                            ...
                            <div className="text-center">
                                <AlertCircle className="w-10 h-10 text-[#46a1bb] mx-auto mb-4" />
