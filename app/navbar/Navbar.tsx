    ...
    const menuItems: MenuItem[] = [
        ...
        },
        {
            ...
            submenu: [
                ...
                { name: 'Project Research Reports', href: '/press/project-research-reports' },
                { name: 'Policy Briefs', href: '/press/policy-briefs' },
                { name: 'Books', href: '/press/books' },
                { name: 'Position Papers', href: '/press/position-papers' },
                ...
                { name: 'ARIN Review Briefs', href: '/press/review-briefs' },
